...
/*int NumRomanos (void) 
{
    ...
    /*if(numero != (int)numero) // falta sacar la parte entera de número
    {
    ...
    if (convertible == true)
    {
    // Realizamos los cálculos para ir fragmentando el número.
    // Miles:
    imiles = numero/1000;
    ...
    // Mostramos los dígitos convertidos a romanos.
